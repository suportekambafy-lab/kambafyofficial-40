-- Recriar a função para adicionar alunos à turma com lógica corrigida
-- Garantir que o cohort_id seja atualizado no pedido
...
BEGIN
  ...
  IF NEW.cohort_id IS NOT NULL THEN
    ...
    END IF;
  ELSE
    -- Se não tem cohort_id no pedido, buscar a primeira turma ativa (turma padrão)
    ...
    IF default_cohort_id IS NOT NULL THEN
      ...
      -- IMPORTANTE: Atualizar o pedido com o cohort_id
