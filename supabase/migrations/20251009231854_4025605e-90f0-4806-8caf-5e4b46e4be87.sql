...
-- Deletar vendas existentes do produto Leonardo
DELETE FROM orders WHERE product_id = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa';

-- Deletar transações existentes de Leonardo
...
-- Atualizar saldo para 3.080.000 KZ
