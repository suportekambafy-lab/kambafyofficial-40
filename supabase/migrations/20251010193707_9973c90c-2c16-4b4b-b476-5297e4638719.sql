-- Garantir que pgcrypto está instalada no schema extensions (padrão Supabase)
CREATE EXTENSION IF NOT EXISTS pgcrypto WITH SCHEMA extensions;

-- Recriar função usando referência completa ao schema
...
BEGIN
  ...
  -- Criar novo admin usando referência completa ao schema extensions
