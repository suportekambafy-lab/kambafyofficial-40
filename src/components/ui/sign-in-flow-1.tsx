...
interface SignInPageProps {
  ...
  onUserTypeSelect?: (type: 'customer' | 'seller' | null) => void;
...
export const SignInPage = ({ 
          ...
          <div className="w-full max-w-sm space-y-12">
            ...
            <div className="space-y-6">
              <button
                ...
                className="w-full bg-white hover:bg-gray-50 text-checkout-green py-4 text-lg font-semibold rounded-2xl shadow-lg border-2 border-white/20 transition-colors"
              >
                Sou Cliente
              </button>
  ...
  const handleGoogleSignIn = () => {
    ...
    // Google sign in será tratado pelo componente pai
  };
  ...
  const userTypeText = selectedUserType === 'customer' ? 'Cliente' : 'Vendedor';
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">
                        Bem-vindo {userTypeText}
                      </h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Faça login no Kambafy</p>
                    </div>
                    ...
                    <p className="text-xs text-white/40 pt-6">
                      ...
                      <Link to="/terms" className="underline text-white/40 hover:text-white/60 transition-colors">
                        Termos
                      </Link>{" "}
                      e{" "}
                      <Link to="/privacy" className="underline text-white/40 hover:text-white/60 transition-colors">
