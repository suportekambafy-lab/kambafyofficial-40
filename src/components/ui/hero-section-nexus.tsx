...
const NavLink: React.FC<NavLinkProps> = ({
  ...
  className = "",
  onClick
}) => <a href={href} onClick={onClick} className={cn("relative group text-sm font-medium text-gray-300 hover:text-white transition-colors duration-200 flex items-center py-1", className)}>
     {children}
...
const InteractiveHero: React.FC = () => {
  ...
  return <div className="relative bg-[#111111] text-gray-300 overflow-x-hidden">
      ...
      ease: "easeInOut"
            ...
            <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
                <div className="flex items-center flex-shrink-0">
                    <img src="/kambafy-logo-white.png" alt="Kambafy" className="h-12 w-auto" />
                </div>
                ...
                <div className="flex items-center flex-shrink-0 space-x-4 lg:space-x-6">
                    ...
                    <motion.button onClick={() => handleAuthNavigation('signup')} className="bg-[#0CF2A0] text-[#111111] px-4 py-[6px] rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md" whileHover={{
            scale: 1.03,
            y: -1
          }} whileTap={{
            scale: 0.97
        ...
        <main className="relative z-10">
          <section className="flex flex-col items-center justify-center text-center px-4 pt-32 pb-16">
            ...
            <motion.h1 variants={headlineVariants} initial="hidden" animate="visible" className="text-4xl sm:text-5xl lg:text-[64px] font-bold text-white leading-tight max-w-4xl mb-4">
                ...
                <span className="inline-block h-[1.2em] overflow-hidden align-bottom">
                    <RotatingText texts={['digitais', 'criativos', 'exclusivos', 'incríveis', 'únicos']} mainClassName="text-[#0CF2A0] mx-1" staggerFrom={"last"} initial={{
              y: "-100%",
              opacity: 0
            }} animate={{
              y: 0,
            ...
            <motion.div variants={formVariants} initial="hidden" animate="visible" className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto mb-3">
                <motion.button onClick={() => handleAuthNavigation('signup')} className="w-full sm:w-auto bg-[#0CF2A0] text-[#111111] px-8 py-3 rounded-md text-base font-semibold hover:bg-opacity-90 transition-colors duration-200 shadow-lg hover:shadow-xl flex-shrink-0" whileHover={{
            scale: 1.03,
            y: -1
          }} whileTap={{
            scale: 0.97
            ...
            damping: 15
                ...
                <motion.button className="w-full sm:w-auto bg-transparent border border-[#0CF2A0] text-[#0CF2A0] px-8 py-3 rounded-md text-base font-semibold hover:bg-[#0CF2A0]/10 transition-colors duration-200 flex items-center justify-center gap-2" whileHover={{
            scale: 1.03,
            y: -1
          }} whileTap={{
            scale: 0.97
            ...
            <motion.p variants={trialTextVariants} initial="hidden" animate="visible" className="text-xs text-gray-500 mb-16">
          ...
          <section id="recursos" className="py-24 px-6 relative z-10">
              <div className="mx-auto max-w-7xl">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                      ...
                      <div className="relative">
                          <img src={teamImage} alt="Profissionais colaborando" className="rounded-2xl shadow-lg object-cover w-full h-80 lg:h-96" />
            ...
            }].map((feature, index) => <div key={index} className="bg-[#1a1a1a] border border-gray-700/50 rounded-lg p-6 hover:border-[#0CF2A0]/50 transition-all duration-300">
          ...
          <section className="py-24 px-6 relative z-10">
            ...
            }].map((testimonial, index) => <div key={index} className="bg-[#1a1a1a] border border-gray-700/50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                      <div>
                          ...
                          <div className="space-y-4">
                              {["Plataforma 100% nacional", "Pagamentos em multimoedas", "Suporte em português"].map((item, index) => <div key={index} className="flex items-center space-x-3">
          ...
          <section className="py-24 px-6 relative z-10">
              <div className="mx-auto max-w-4xl text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <Button size="lg" className="bg-[#0CF2A0] hover:bg-[#0CF2A0]/90 text-[#111111] px-8 text-lg" onClick={() => handleAuthNavigation('signup')}>
                          Criar Conta Grátis
