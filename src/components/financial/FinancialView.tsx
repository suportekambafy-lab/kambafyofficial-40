      ...
      <div className="space-y-6 p-4 md:p-6 lg:p-8 max-w-full overflow-x-hidden">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mt-1 sm:mt-2">{t("financial.subtitle")}</p>
          </div>
        ...
        <MultiCurrencyOverview balances={balances} formatCurrency={formatCurrency} getTotalInKZ={getTotalBalanceInKZ} />
