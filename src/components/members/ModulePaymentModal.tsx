    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-6 py-4">
          ...
          {selectedPaymentMethod && selectedPaymentMethod !== 'express' && selectedPaymentMethod !== 'reference' && selectedPaymentMethod !== 'transfer' && !['card', 'klarna', 'multibanco', 'mbway', 'card_uk', 'klarna_uk', 'card_us'].includes(selectedPaymentMethod) && (
            <div className="space-y-2">
              <Label htmlFor="proof">Comprovante de Pagamento</Label>
              <Input
                id="proof"
          ...
          {['card', 'klarna', 'multibanco', 'mbway', 'card_uk', 'klarna_uk', 'card_us'].includes(selectedPaymentMethod) && (
            <div className="mt-4">
