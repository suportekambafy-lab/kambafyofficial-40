...
import { NetflixStatsPanel } from './NetflixStatsPanel';
...
export function NetflixHeroBanner({
  ...
  return (
    <div className="relative w-full">
      {/* Main Hero Container - Grid layout for desktop */}
      <div className="mx-4 md:mx-12 lg:mx-16 mt-20 md:mt-28">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Hero Image/Video - Takes 2 columns on desktop */}
          <div className="lg:col-span-2 relative rounded-3xl overflow-hidden aspect-square md:aspect-video" style={{ maxHeight: '75vh' }}>
          ...
          {/* Stats Panel - Hidden on mobile, shown on desktop */}
          <div className="hidden lg:block lg:col-span-1">
            <div className="h-full" style={{ maxHeight: '75vh' }}>
              <NetflixStatsPanel
