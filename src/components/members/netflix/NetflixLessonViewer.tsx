...
export function NetflixLessonViewer({
  ...
  return (
    <div 
      className="min-h-screen netflix-member-area"
      style={{ 
                    ...
                    <div className="w-full max-w-xl text-center space-y-6 p-8">
                      ...
                      >
                        <Button
                          ...
                          variant="outline"
                          className="gap-2 h-12 px-6 bg-white/10 border-white/20 text-white hover:bg-white/20"
                        >
                        ...
                        {nextLesson && (
                          <Button
                            ...
                            className="gap-2 h-12 px-6 bg-netflix-green hover:bg-netflix-green/90 text-black font-bold"
                          >
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              isActive 
                                ? "bg-netflix-green/10 border-l-2 border-netflix-green" 
                                : "hover:bg-white/5"
                            )}
                          >
                            {/* Thumbnail */}
                            <div className="relative w-24 h-14 rounded-lg overflow-hidden flex-shrink-0 bg-white/10">
                              ...
                              {progress > 0 && !isCompleted && (
                                <div className="absolute bottom-0 left-0 right-0 h-1 bg-black/50">
                                  <div 
                                    className="h-full bg-netflix-green"
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2">
                                ...
                                {isCompleted && (
                                  <CheckCircle2 className="w-3.5 h-3.5 text-netflix-green" />
                                )}
                              </div>
                              <h4 className={cn(
                                "text-sm font-medium line-clamp-1",
                                isActive ? "text-netflix-green" : "text-white"
                              )}>
                                {l.title}
                              </h4>
                              {l.duration > 0 && (
