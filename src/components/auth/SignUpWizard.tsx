...
const COUNTRIES = [
  ...
  { code: 'MZ', name: 'Moçambique', flag: '🇲🇿', currency: 'MZN' },
...
const PRODUCT_TYPES = [
  { id: 'ebook', label: 'E-books', icon: BookOpen, description: 'PDFs, guias, manuais' },
  { id: 'curso', label: 'Cursos Online', icon: Video, description: 'Videoaulas, formações' },
  { id: 'mentoria', label: 'Mentorias', icon: User, description: 'Acompanhamento 1:1' },
  { id: 'template', label: 'Templates', icon: Package, description: 'Modelos prontos' },
  { id: 'outro', label: 'Outros', icon: Sparkles, description: 'Serviços, físicos' },
];
...
export const SignUpWizard: React.FC<SignUpWizardProps> = ({
  ...
  const { userCountry, loading: geoLoading } = useGeoLocation();
