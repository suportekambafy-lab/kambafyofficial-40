  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_200px] gap-3">
      ...
      <div className="flex flex-col gap-2">
        <Card className="rounded-xl border border-border/40 bg-card p-4 flex-1">
          ...
          <p className="text-2xl font-bold text-foreground mt-1">{ordersCount.toLocaleString()}</p>
        </Card>
        ...
        <Card className="rounded-xl border border-border/40 bg-card p-4 flex-1">
          ...
          <span className="text-[10px] text-muted-foreground">{filterLabel}</span>
          <p className="text-2xl font-bold text-foreground mt-1">{paidOrdersCount.toLocaleString()}</p>
        </Card>
      </div>
    </div>
  );
