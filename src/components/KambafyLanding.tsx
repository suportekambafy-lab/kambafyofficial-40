          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            <div className="flex w-full justify-between lg:w-auto">
              <Link to="/" aria-label="home" className="flex items-center space-x-2">
                <img 
                  src="/lovable-uploads/36bc3a07-1c71-4ba2-b5e9-08b210b81348.png" 
                  alt="Kambafy" 
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
            <AnimatedGroup variants={transitionVariants}>
              ...
              <h1 className="mt-8 max-w-4xl mx-auto text-balance sm:text-4xl lg:text-6xl xl:text-7xl lg:mt-16 font-bold md:text-4xl text-3xl text-checkout-green font-bricolage">Transforme Seu Conhecimento Em Renda</h1>
