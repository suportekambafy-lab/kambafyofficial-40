      ...
      case 'stats':
        return (
          <div className="p-4 space-y-4">
            ...
            {/* Financial Cards */}
            <div className="space-y-3">
              <Card className="overflow-hidden border-l-[6px] border-l-green-500 shadow-sm bg-white">
              ...
              <Card className="overflow-hidden border-l-[6px] border-l-yellow-500 shadow-sm bg-white">
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2">
