  ...
  if (loginStep === 'awaiting_2fa' && email) {
    return <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <TwoFactorVerification email={email} context="login" onVerificationSuccess={handle2FASuccess} onBack={handle2FACancel} skipInitialSend={true} />
          </CardContent>
        </Card>
      </div>;
  }
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-checkout-green hover:bg-checkout-green/90" disabled={isLoading}>
