                      ...
                      <Route path="/apps" element={<OptimizedRoutes.Apps />} />
                       <Route path="/vendedor/*" element={<OptimizedRoutes.SellerDashboard />} />
                        ...
                        <Route path="/identidade" element={<OptimizedRoutes.UserIdentity />} />
                         ...
                         <Route path="/area/:id" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.MemberArea /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
                         <Route path="/area/:id/content" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.MemberAreaContent /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
                         <Route path="/area/:id/support-materials" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.MemberAreaSupportMaterials /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
                         <Route path="/area/:id/about" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.MemberAreaAbout /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
                         <Route path="/area/:id/my-courses" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.MemberAreaMyCourses /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
                         <Route path="/area/:id/support" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.MemberAreaSupport /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
                         <Route path="/area/:id/help" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.MemberAreaHelp /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
                         <Route path="/login/:id" element={<OptimizedRoutes.MemberAreaLoginWrapper />} />
                         <Route path="/area/:id/module/:moduleId" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.ModuleDetail /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
                         <Route path="/area/:id/lesson/:lessonId" element={<OptimizedRoutes.ProtectedMemberAreaRoute><OptimizedRoutes.LessonDetail /></OptimizedRoutes.ProtectedMemberAreaRoute>} />
